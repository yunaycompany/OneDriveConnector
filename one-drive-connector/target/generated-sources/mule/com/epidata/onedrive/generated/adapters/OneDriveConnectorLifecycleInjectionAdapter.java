...
/**
 * A <code>OneDriveConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link OneDriveConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-02-07T04:46:05-03:00", comments = "Build UNNAMED.2793.f49b6c7")
public class OneDriveConnectorLifecycleInjectionAdapter
    extends OneDriveConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(OneDriveConnectorLifecycleInjectionAdapter.class);
