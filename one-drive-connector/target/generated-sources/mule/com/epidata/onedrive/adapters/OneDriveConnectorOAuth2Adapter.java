...
package com.epidata.onedrive.adapters;

import com.epidata.onedrive.OneDriveConnector;
import com.epidata.onedrive.config.ConnectorConfig;
import com.epidata.onedrive.generated.adapters.OneDriveConnectorCapabilitiesAdapter;
import com.epidata.onedrive.generated.adapters.OneDriveConnectorProcessAdapter;
...
/**
 * A {@code OneDriveConnectorOAuth2Adapter} is a wrapper around {@link OneDriveConnector } that adds OAuth capabilites to the pojo.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-02-07T04:46:05-03:00", comments = "Build UNNAMED.2793.f49b6c7")
public class OneDriveConnectorOAuth2Adapter
    extends OneDriveConnectorProcessAdapter
    implements OAuth2Adapter
{
    ...
    private final static Logger LOGGER = Logger.getLogger(OneDriveConnectorOAuth2Adapter.class);

    public OneDriveConnectorOAuth2Adapter(OAuth2Manager<OAuth2Adapter> oauthManager) {
    ...
    public String getConsumerKey() {
        return ((ConnectorConfig) super.getConfig()).getClientId();
    }

    @Override
    public void setConsumerKey(String value) {
        ((ConnectorConfig) super.getConfig()).setClientId(value);
    }

    @Override
    public String getConsumerSecret() {
        return ((ConnectorConfig) super.getConfig()).getClientSecret();
    }

    @Override
    public void setConsumerSecret(String value) {
        ((ConnectorConfig) super.getConfig()).setClientSecret(value);
    }
    ...
    public String getScope() {
        return ((ConnectorConfig) super.getConfig()).getScope();
    }

    public void setScope(String value) {
        ((ConnectorConfig) super.getConfig()).setScope(value);
    }
